        ...
        <form class="form-horizontal" action="delete_card.php" method="POST">
          ...
          <div class="form-group" >
            ...
            <div class="col-sm-5" align='left'>
               <input type="text" class="form-control" id="exampleInputPassword1" name="cid" placeholder=""></input>
            </div>  
          </div>
          <div class="form-group" >
            <!-- <label for="OldPassword">Old password</label> -->
            ...
            <div class="col-sm-5" align='left'>
               <input type="text" class="form-control" id="exampleInputPassword1" name="cname" placeholder=""></input>
            </div>  
          </div>
